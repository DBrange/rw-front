import { DamageVehiclesValues, ErrorsDamageVehiclesValues } from "../../models";

export const validateDamageVehicle = ({
  time,
  date,
  location,
  reportPhoto,
  ...
  const errors: Partial<ErrorsDamageVehiclesValues> | null = {};
