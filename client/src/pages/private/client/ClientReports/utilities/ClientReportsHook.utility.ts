...
import { AllUserSinisterUrl, allSinister } from "..";

function ClientReportsHook<T>(
  searchField: string,
  ...
  const {
    ...
    mutate,
    isLoading,
  } = useSWRInfinite(getKey, allSinister);
...
export default ClientReportsHook;
